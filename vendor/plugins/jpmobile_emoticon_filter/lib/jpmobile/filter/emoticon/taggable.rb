...
if defined? ActionController::Request
  module ActionController
    class AbstractRequest < ActionController::Request
      class << self
        unless respond_to?(:relative_url_root)
        ...
        def to_external(str, controller)
          ...
          utf8_str.gsub(Jpmobile::Emoticon::UTF8_REGEXP) do |match|
            ...
            if Jpmobile::Emoticon::DOCOMO_UNICODE_TO_TYPEPAD[docomo_code]
              relative_url_root = controller.respond_to?(:relative_url_root) ? controller.relative_url_root : controller.request.relative_url_root
              img_builder.call(File.join(relative_url_root.to_s,
                                       "images",
                                       @emoticon_dir,
